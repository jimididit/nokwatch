    ...
    try:
        if is_test:
            ...
            blocks = [
                {
                    "type": "header",
                    "text": {"type": "plain_text", "text": f"Website Monitor Alert: {job['name']}"}
                },
                {
                    "type": "section",
                    "text": {
